<template>
  <div class="wrapper">
    ...
    <div>
      <Footer :ItemData="ItemData" @Open0="Open0()" @Open1="Open1()" @Open2="Open2()" @Open2_5="Open2_5()" @Open3="Open3()" @Open3_5="Open3_5()"></Footer>
    </div>
  </div>
</template>
...
import Materials3_5 from './components/Materials3_5.vue';
...
export default {
  ...
  methods: {
    ...
    Open3_5() {
      ...
      else if(this.Materials3_5 == true) {
